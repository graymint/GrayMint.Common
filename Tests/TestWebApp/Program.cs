...
public class Program
{
    public static Task Main(string[] args)
    {
        ...
        builder.Services.AddGrayMintJob<MyJobService>(new JobConfig { Interval = TimeSpan.FromSeconds(20), DueTime = TimeSpan.Zero, Name = "MyJobService" });
        builder.Services.AddGrayMintJob<MyJobService2>(new JobConfig { Interval = TimeSpan.FromSeconds(20) });
